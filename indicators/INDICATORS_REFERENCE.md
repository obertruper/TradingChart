...
6. [ATR (Average True Range)](#-atr-average-true-range---средний-истинный-диапазон) - Средний истинный диапазон
7. [Bollinger Bands](#-bollinger-bands-bb---полосы-боллинджера) - Полосы Боллинджера

### Объемные индикаторы
8. [VMA (Volume Moving Average)](#-vma-volume-moving-average---скользящая-средняя-объема) - Скользящая средняя объема

### Сентимент-индикаторы
9. [Fear & Greed Index](#-fear--greed-index---индекс-страха-и-жадности) - Индекс страха и жадности (Alternative.me и CoinMarketCap)
