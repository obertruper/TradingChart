...
| Метрика | Значение |
|---------|----------|
| Записей в БД | 1,065,199 |
| Дней загружено | 741 |
| Период | 2023-01-18 → 2025-01-27 (загрузка продолжается) |
| Символ | BTCUSDT |
| Размер таблицы | ~3.2 GB |
...
Статистика рассчитана на **реальных данных BTCUSDT** (1,065,199 записей, 2023-01-18 → 2025-01-27).
