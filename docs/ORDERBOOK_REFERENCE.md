...
**Скрипт:** `indicators/orderbook_bybit_loader.py`
...
| Скрипт | `orderbook_bybit_loader.py` | `orderbook_binance_loader.py` |
| Документация | Этот файл | [ORDERBOOK_BINANCE_REFERENCE.md](ORDERBOOK_BINANCE_REFERENCE.md) |

**Примечание:** bookTicker данные Binance доступны только за период 2023-05-16 → 2024-03-30 (Binance прекратил публикацию). bookDepth данные продолжают публиковаться.
